...
public class TracingUtil
{
    public static class TraceEntry
    {
        ...
        public final InetAddressAndPort source;
        public final int sourceElapsed;
        public final String thread;

        private TraceEntry(UUID sessionId, UUID eventId, String activity, InetAddress sourceIP, int port, int sourceElapsed, String thread)
        {
            this.sessionId = sessionId;
            this.eventId = eventId;
            this.activity = activity;
            this.source = InetAddressAndPort.getByAddressOverrideDefaults(sourceIP, port);
    ...
    public static List<TraceEntry> getTrace(AbstractCluster cluster, UUID sessionId, ConsistencyLevel cl)
    {
        ...
        "SELECT session_id, event_id, activity, source, source_port, source_elapsed, thread " +
